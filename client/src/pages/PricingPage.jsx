...
export default function PricingPage() {
    ...
    useEffect(() => { trackEvent("pricing_viewed"); api.get("/billing/entitlements").then(({ data }) => setEntitlements(data)).catch(() => setError("We couldn’t load your current plan. Try refreshing the page.")).finally(() => setEntitlementsLoading(false)); }, []);
