...
CompanionAI processes resumes, interview answers, and job descriptions and may send that content to configured AI providers. Production operators must document the selected providers, retention behavior, subprocessors, deletion policy, and user data export process in the published privacy notice.
