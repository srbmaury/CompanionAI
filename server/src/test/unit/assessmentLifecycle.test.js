...
describe("assessment lifecycle processing", () => {
    beforeEach(() => { vi.clearAllMocks(); updateMany.mockResolvedValue({ modifiedCount: 1 }); find.mockResolvedValue([]); });
    ...
    it("delivers queued invitations and records provider state", async () => {
